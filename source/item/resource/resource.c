...
void init_resources() {
	...
	static TileID torch_sources[] = {GRASS, DIRT, SAND, FARMLAND, WOOD_FLOOR, STONE_FLOOR, DIRT_PATH, ROCK, HARD_ROCK};
	...
	static TileID stonewall_sources[] = {DIRT, GRASS, SAND, WOOD_FLOOR, STONE_FLOOR, HOLE, DIRT_PATH, ROCK, HARD_ROCK};
	...
	static TileID pot_sources[] = {DIRT, GRASS, SAND, WOOD_FLOOR, STONE_FLOOR, DIRT_PATH, ROCK, HARD_ROCK};
	...
	static TileID tombstone_sources[] = {DIRT, GRASS, SAND, DIRT_PATH, ROCK, HARD_ROCK};
	...
	static TileID fence_sources[] = {DIRT, GRASS, SAND, WOOD_FLOOR, STONE_FLOOR, DIRT_PATH, ROCK, HARD_ROCK};
	...
	static TileID stonefloor_sources[] = {DIRT, GRASS, SAND, HOLE, DIRT_PATH, WOOD_FLOOR, ROCK, HARD_ROCK};
	...
	static TileID glasswall_sources[] = {DIRT, GRASS, SAND, HOLE, DIRT_PATH, WOOD_FLOOR, STONE_FLOOR, ROCK, HARD_ROCK};
	...
	static TileID ladder_sources[] = {DIRT, GRASS, SAND, DIRT_PATH, WOOD_FLOOR, STONE_FLOOR, ROCK, HARD_ROCK, STONE_WALL, WOOD_WALL};
